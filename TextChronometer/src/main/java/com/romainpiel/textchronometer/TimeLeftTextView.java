...
/**
 * Created by hazer on 3/19/15.
 */
public class TimeLeftTextView extends TextView {
    ...
    public TimeLeftTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TimeLeftTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void onTimeChanged() {
        DateRenderer.TimeAgo timeAgo = dateRenderer.timeLeft(time);
